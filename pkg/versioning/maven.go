...
func (m *Maven) init() {
	...
	if m.mavenUtils == nil {
		m.mavenUtils = maven.NewUtilsBundle()
	}
}
...
func (m *Maven) GetPackaging() (string, error) {
	...
	packaging, err := m.runner.Evaluate(&m.options, "project.packaging", m.mavenUtils)
	if err != nil {
...
func (m *Maven) GetGroupID() (string, error) {
	...
	groupID, err := m.runner.Evaluate(&m.options, "project.groupId", m.mavenUtils)
	if err != nil {
...
func (m *Maven) GetArtifactID() (string, error) {
	...
	artifactID, err := m.runner.Evaluate(&m.options, "project.artifactId", m.mavenUtils)
	if err != nil {
...
func (m *Maven) GetVersion() (string, error) {
	...
	version, err := m.runner.Evaluate(&m.options, "project.version", m.mavenUtils)
	if err != nil {
...
func (m *Maven) SetVersion(version string) error {
	...
	_, err = m.runner.Execute(&opts, m.mavenUtils)
	if err != nil {
